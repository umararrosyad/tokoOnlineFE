<template>
  <v-navigation-drawer app permanent class="pa-3" >
    <v-list nav>
      ...
      <v-list-item
        link
        @click="$router.push('/dashboard/produk')"
        rounded
        :active="this.$route.name === '/dashboard/produk/'"
        >
        <v-list-item-content>
      ...
      <v-list-item
        link
        @click="$router.push('/dashboard/kategori')"
        rounded
        :active="this.$route.name === '/dashboard/kategori/'"
...
export default {
  ...
  mounted() {
    ...
    console.log(this.$route.name)// Set default route
  },
  methods: {
